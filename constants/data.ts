...
export const DEPARTMENTS: ProjectType[] = [
  ...
  },
  {
    ...
    image: '/images/department/education-department-b67fd5a8.png',
  },
  {
    name: 'Treasury Department',
    page: 'department',
    description:
      'The Treasury Department’s mission is to safeguard and improve the DAOs financial infrastructure, driven by values such as transparency, integrity, responsibility, and accountability. Under Treasury Department Accounting, it oversees financial matters, reports, assets, budgets, and meticulous records to ensure responsible financial management.',
    image: '/images/department/treasury-department-21b91718.png',
  },
]

export const GUILDS: ProjectType[] = [
  {
    name: 'Project Management Guild',
    page: 'guild',
    description:
      'A space for BanklessDAO creators to do their best work via project management best practices. We explore how PM best practices can be used within the web3 space and DAOs.',
    image: '/images/guild/project-management-guild-2fcc8bd2.jpg',
  },
  {
    name: 'Audiovidual Guild',
    page: 'guild',
    description:
    ...
    image: '/images/guild/audiovidual-guild-f901620b.png',
  },
  {
  ...
  },
  {
    ...
    image: '/images/guild/developers-guild-7e988ba9.png',
  },
  {
    name: 'Legal Guild',
    page: 'guild',
    ...
    image: '/images/guild/legal-guild-8cbb4e0a.png',
  },
  {
    name: 'Research Guild',
    page: 'guild',
    ...
    image: '/images/guild/research-guild-71c70417.png',
  },
  {
    name: 'Translators Guild',
    page: 'guild',
    description:
    ...
    image: '/images/guild/translators-guild-4f0af1f4.png',
  },
  {
    name: 'Writers Guild',
    page: 'guild',
    ...
    image: '/images/guild/writers-guild-22c8e4ea.png',
  },
  {
    name: 'Analytics Guild (inactive)',
    page: 'guild',
    description:
    ...
    image: '/images/guild/analytics-guild-inactive-cc3f4998.png',
  },
]
...
export const PROJECTS: ProjectType[] = [
  {
    ...
    page: 'project',
    description:
      'Bankless Card aims to provide bootstrap funding to every community through card interchange revenues. DAO members can use Bankless Card for their everyday purchases to earn cashback in the form of DAO social tokens. New contributors can also learn core web3 concepts through in-app integrations (i.e. Snapshot, PoolTogether, and more).',
    image: '/images/project/bankless-card-5fa77bc9.png',
    link: 'https://banklesscard.xyz/',
  },
  {
    name: 'Bankless Consulting',
    page: 'project',
    description:
      'Bankless Consulting is the consulting services arm of BanklessDAO. It connects over 15,000+ talented Web3 natives to professional services in marketing, tech, legal, finance, and management. Bankless Consulting helps decentralized, Web3-native, and traditional businesses leverage the power of Web3.',
    image: '/images/project/bankless-consulting-44709f18.png',
  ...
  },
  {
    ...
    page: 'project',
    description:
      'The Bounty Board creates an efficient mechanism of coordination between organizers and contributors. It provides a way to quickly access Web3 talent within the DAO for bountied work.',
    image: '/images/project/bounty-board-7aee2b5b.png',
    link: 'https://bankless.notion.site/Bounty-Board-Project-Page-318dc164cc5640cca17e0fb5f484fd90',
  },
  {
    name: 'Newsletter Project',
    page: 'project',
    description:
      'The Newsletter project provides a written voice for the Bankless movement through newsletters that each have tens of thousands of subscribers: Weekly Rollup, State of the DAOs, Decentralized Arts and DeFi Download.',
    image: '/images/project/newsletter-project-8cd6b42c.png',
    link: 'https://banklessdao.substack.com/',
  },
  {
    ...
    image: '/images/project/bankless-publishing-5ae88c23.png',
    link: 'https://banklesspublishing.com/',
  },
  {
    name: 'Podcast Hatchery',
    page: 'project',
    description:
      'Podcast Hatchery empowers individual creators to develop their own podcasts, improve their production skills, grow an audience and ultimately generate high-quality audio storytelling that will represent the mission, ethos, and diversity of BanklessDAO.',
    image: '/images/project/podcast-hatchery-72cf6a81.png',
    link: 'https://bankless.notion.site/Podcast-Hatchery-0c2676175267445180c8f5cb3d3f14bb',
  },
  {
    name: 'DAOversity',
    page: 'project',
    description:
      'DAOversity aims to understand and improve diversity within BanklessDAO. It works to provide a safe and inclusive space for discussing and addressing the challenges minority groups face in DAOs and Web3.',
    image: '/images/project/daoversity-3c60baa3.png',
    link: 'https://discord.com/channels/834499078434979890/896079056427163679',
  },
  {
    name: 'Fight Club',
    page: 'project',
    description:
      'Fight Club aims to create opportunities for the bDAO community to pool capital, invest in projects, and share proceeds while offering venture investing education.',
    image: '/images/project/fight-club-7994c99c.png',
    link: 'https://twitter.com/fight_club_vc',
  },
  {
    name: 'Bankless Loans',
    page: 'project',
    description:
      'The Bankless Loans Project Team is building a DeFi application for BanklessDAO that supports its goal of onboarding one billion people to crypto while generating revenue for the bDAO treasury.',
    image: '/images/project/bankless-loans-44bedebe.png',
    link: 'https://bankless.notion.site/Bankless-Loans-c6b90fad24b24312b184840e49694f7f',
  },
  {
    name: 'Bankless Academy',
    page: 'project',
    description:
      'Bankless Academy is an app that will take someone with zero knowledge of crypto and smart contracts and lead them down the journey of becoming a competent crypto user. They provide lessons in interactive formats and have fun rewards along the way.',
  ...
  },
  {
    ...
    page: 'project',
    description:
      'Humpty, one of bDAO’s active contributors, hosts a weekly podcast featuring insightful voices of Web3. Listen here.',
    image: '/images/project/crypto-sapiens-2b6a14b8.png',
    link: 'https://linktr.ee/CryptoSapiensOfficial',
  },
  {
    name: 'First Quest',
    page: 'project',
    description:
      'First Quest is building our onboarding process, which has become famous within Web3. First Quest project aims to serve new joiners with a simplified and gamified onboarding process.',
    image: '/images/project/first-quest-56ffbb70.png',
    link: 'https://bankless.notion.site/First-Quest-Project-Page-abc1393b83ae47f5836004ae96f55072',
  },
  {
    name: 'International Media Nodes',
    page: 'project',
    description:
      'International Media Nodes (IMN) are Bankless channels that spread the message of the Bankless movement to regions beyond North America. They translate BanklessDAO content, publish original pieces, run Twitter pages, and ship newsletters to cover many of the regions and languages of the world.',
    image: '/images/project/international-media-nodes-b252f488.png',
    link: 'https://banklessimn.com/',
  },
  {
    name: 'Decentralized-Law-Newsletter',
    page: 'project',
    description:
      'The Legal Guild runs a legal newsletter that covers developments in the crypto-legal landscape. It is a premier newsletter in the crypto space, publishing cutting-edge legal analysis monthly.',
    image: '/images/project/decentralized-law-newsletter-1a59dae7.png',
    link: 'https://banklessdao.substack.com/s/decentralized-law',
  },
  {
    name: 'InfoSec Team',
    page: 'project',
    ...
    image: '/images/project/infosec-team-b8853437.png',
    link: 'https://infosec.bankless.community/',
  },
  {
    name: 'Website Project',
    page: 'project',
    description:
      'The Website project aims to constantly improve the code, content, and design of the current bDAO website to streamline the introduction and onboarding of new members to the Bankless movement.',
    image: '/images/project/website-project-fa2f4330.png',
    link: 'https://www.notion.so/bankless/bDAO-Website-1320df854ac54cb3a65018173b9e5445',
  },
  {
    name: 'Governator',
    page: 'project',
    description:
      'Token voting in Discord. Easy-to-use, token-enabled, shielded polls right in your server.',
    image: '/images/project/governator-9624f47d.jpg',
    link: 'https://www.governator.xyz/',
  },
  {
    name: 'The Rug',
    page: 'project',
    description:
      'The Rug is the premiere crypto-satire brand in Web3. Subscribe to our newsletter for the hardest hitting articles and headlines. We take money, seriously.',
    image: '/images/project/the-rug-1c23cd89.png',
    link: 'https://www.therugnews.com/',
  },
  {
    name: 'Making Bank',
    page: 'project',
  ...
  },
  {
    ...
    page: 'project',
    description:
      'B Labs offers web3 related, data-driven and evidence-based analysis, research and advisory services. We support our partners in concept creation, goal setting and decision-making to successfully access, navigate and thrive in the space.',
    image: '/images/project/b-labs-18ae22d7.png',
    link: 'https://linktr.ee/blabsresearch',
  },
  {
    name: 'Bankless Africa',
    page: 'project',
    description:
      'Bankless Africa promotes, educates and propagate truely bankless media, culture and education to drive the adoption of trustless, decentralized money and blockchain technology with the aim of achieving capacity building, economic empowerment and financial sovereignty in Africa.',
    image: '/images/project/bankless-africa-49fdf43d.png',
    link: 'https://www.banklessafrica.com/',
  },
  {
    name: 'DAOStewards',
    page: 'project',
...
export const WORK_WITH_US: ProjectType[] = [
  ...
  },
  {
    ...
    category: 'consulting-and-education',
    description:
      'The Global Tax Guide will provide general introductory information regarding virtual-currency-related income tax laws from major jurisdictions throughout the world. Access to the Global Tax Guide will be granted by minting Form 69.',
  ...
  },
  {
    ...
    category: 'creative-services',
    description:
      'Bankless Publishing (BP) is available to collaborate with value-aligned brands and protocols to generate educational articles that promote awareness, knowledge, and functionality of various integral aspects of the web3 ecosystem.',
  ...
  },
  {
    ...
    category: 'creative-services',
    description:
      'State of the DAOs, the high-signal low-noise newsletter to understanding DAOs.',
    image:
      '/images/work-with-us/state-of-the-daos-newsletter-feature-5609ac88.jpg',
